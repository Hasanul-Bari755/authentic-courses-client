...
const CourseDetails = () => {
   ...
   return (
        ...
        <div className="flex flex-col">
          <div  className="max-w-xl mb-6 bg-slate-500 p-4 rounded-sm">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-black-900 sm:text-4xl sm:leading-none">
              {name}
              
            </h2>
            <p className="text-base text-black-900 md:text-lg">
              {description}
            </p>
          </div>
             <div className='flex'>
