...
const Home = () => {
    return (
        ...
        <section className="dark:bg-gray-800 dark:text-gray-100">
	     <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 flex justify-center  justify-items-center lg:flex-row flex-col">
			...
			<div className="p-6 space-y-2 lg:col-span-5">
				...
				<img src="https://www.aalpha.net/wp-content/uploads/2021/02/python-for-web-development.gif" alt="" />
			</div>
